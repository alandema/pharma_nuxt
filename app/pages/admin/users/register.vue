...
const submit = async () => {
  ...
  try {
    ...
    addToast(
      "Prescritor criado como inativo. Um e-mail de ativação foi enviado.",
      "success",
    );
    ...
    addToast(
      error?.data?.statusMessage ??
        error?.data?.message ??
        "Não foi possível criar o prescritor. Verifique os dados e tente novamente.",
      "error",
    );
  }
};
...
<template>
  ...
  <div class="card">
    <form @submit.prevent="submit" class="grid-form">
      ...
      <div class="form-group text-muted" style="align-self: end">
        A senha deve ter 8-25 caracteres com letras e números.
      </div>
      <div class="form-group">
        <label>Email *</label>
      ...
      <div
        ...
        "
      >
        <input type="checkbox" id="se_admin_register" v-model="f.send_email" />
        <label for="se_admin_register" style="margin: 0"
      ...
      <div class="form-group">
        ...
        <input v-model="f.full_name" required />
      </div>
      <div class="form-group">
        <label>CPF *</label>
        <input
      ...
      <div class="form-group">
        <label>Gênero *</label>
        <select v-model="f.gender" required>
      ...
      <div class="form-group">
        ...
        <input v-model="f.birth_date" type="date" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group" style="grid-column: 1 / -1">
        ...
        <input v-model="f.street" required />
      </div>
      <div class="form-group">
        <label>Número *</label>
        <input v-model="f.address_number" required />
      </div>
      <div class="form-group">
        <label>Complemento</label>
        <input v-model="f.complement" />
      </div>
